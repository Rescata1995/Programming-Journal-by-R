...
dibujarMouse ("red", 149, 149, 151, 151, papel);
...
document.addEventListener ("mousedown", presionarMouse); // o "keydown".
...
/*function soltarMouse (evento2)/* nota: los eventos no necesitan parametros, son opcionales,
