...
document.write(" <br> Mi numero aleatorio seleccionado fue " + num_seleccionado + ".<br>"); // salto de linea: <br>

// probemos con bucles for

var numeros_seleccionados;

for (var i=0; i < 10; i++) {

numeros_seleccionados = aleatorio (100,50);
document.write (numeros_seleccionados + ", ");
